...
window.syncFromCloud = async function() {
    ...
    try {
        ...
        if (!response.ok) throw new Error("Google Script URL is unreachable or private.");
        ...
        try {
            ...
            throw new Error("Invalid response format. Ensure AppScript returns JSON.");
        }
...
window.runCalculationEngine = function(renderGrid = true) {
    try {
        ...
        // 🌟 FIX: Reset status text properly after success
...
// ... [The rest of the code (Optimizer, Edit Modal, Render Exam/Sub, PDF Export) remains exactly the same as previous step] ...
